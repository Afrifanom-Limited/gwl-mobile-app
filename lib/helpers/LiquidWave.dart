...
class LiquidWave extends StatefulWidget {
  ...
  const LiquidWave(
      {Key? key, this.percentageValue = 100.0, this.title = "", this.body = ""})
      : super(key: key);
  @override
  _LiquidWaveState createState() => _LiquidWaveState();
}

class _LiquidWaveState extends State<LiquidWave> with TickerProviderStateMixin {
