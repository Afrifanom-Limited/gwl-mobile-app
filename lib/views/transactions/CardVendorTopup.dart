...
class CardVendorTopup extends StatefulWidget {
  ...
  @override
  _CardVendorTopupState createState() => _CardVendorTopupState();
}

class _CardVendorTopupState extends State<CardVendorTopup> {
  ...
  void _submitForm() async {
    ...
    if (!isValid) {
      ...
      if (cardFirst4 != "") {
        _cardNumber = cardFirst4 + " " + _cardNumberController.text + " " + cardLast4;
      }
      ...
      var _data = {
        ...
        "payer_name": "${widget.accountName}",
      };

      var cardNumberFirst = stripWhiteSpaces(_cardNumber).toString().substring(0, 4);
      var cardNumberLast = stripWhiteSpaces(_cardNumber).toString().substring(12, 16);
      var saveCardData = {
  ...
  _toggleAllowSaveCardInfo(selectedValue) async {
    try {
      SharedPreferences _localStorage = await SharedPreferences.getInstance();
      if (selectedValue) {
        await _localStorage.setBool(Constants.allowSaveCardInfo, this._toggleSaveCardInfo);
        setState(() => this._toggleSaveCardInfo = true);
      } else {
        showDialog(
          context: context,
          builder: (_) => ConfirmDialog(
            ...
            content: "This will clear any saved Card Details."
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      TextFormField(
                        ...
                        validator: (value) => checkNull(value!, "Card holder name"),
                      ...
                      Padding(
                        padding: EdgeInsets.symmetric(horizontal: 5.w, vertical: 10.h),
                        child: GText(
                          textData: cardFirst4 == "" ? "Card Number *" : "Card Number (Enter middle 8 numbers) *",
                          textSize: 12.sp,
                          textColor: Constants.kPrimaryColor,
                        ),
                      ),
                      TextFormField(
                        ...
                        textAlign: cardFirst4 == "" ? TextAlign.left : TextAlign.center,
                        validator: (value) {
                          if (value!.length < 8) return "Invalid card number provided";
                          return null;
                        },
                        toolbarOptions: ToolbarOptions(
                          paste: true,
                        ...
                        inputFormatters: [cardFirst4 == "" ? MaskTextInputFormatter(mask: "#### #### #### ####") : MaskTextInputFormatter(mask: "#### ####")],
                        style: circularTextStyle(),
                        decoration: circularInputDecoration(
                          title: "",
                          prefix: cardFirst4 != ""
                              ? Padding(
                                  padding: EdgeInsets.only(left: 20.w, right: 12.w, top: 12.h, bottom: 12.h),
                                  child: GText(
                                    textData: "$cardFirst4",
                                    textSize: 14.sp,
                                    textColor: Constants.kPrimaryColor,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    TextFormField(
                                      ...
                                      validator: (value) {
                                        if (value!.length < 3) return "Invalid cvv provided";
                                        return null;
                                      },
                                      inputFormatters: [
                        ...
                        Container(
                          ...
                          child: SwitchListTile(
                            ...
                            subtitle: Container(
                              ...
                              child: GText(
                                textData: "The app does not save "
                                    "your full card details. You will need to "
                                    "enter Card Number and CVV for "
                                    "subsequent payments.",
                                textSize: 12.sp,
                                textMaxLines: 4,
                              ),
