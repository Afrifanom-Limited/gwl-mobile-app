...
class EditMeterEmailAddress extends StatefulWidget {
  final dynamic meterInfo;

  const EditMeterEmailAddress({Key? key, required this.meterInfo})
      : super(key: key);
  @override
  _EditMeterEmailAddressState createState() => _EditMeterEmailAddressState();
}

class _EditMeterEmailAddressState extends State<EditMeterEmailAddress> {
  ...
  void _submitForm() async {
    ...
    if (!isValid) {
      ...
      _request.post(
        context,
        url: Endpoints.meters_edit_email_address
            .replaceFirst("{id}", "${_meter["meter_id"]}"),
        data: {"email_address": _emailAddressController.text},
      ...
      child: Scaffold(
        appBar: PreferredSize(
          ...
          child: Container(
            ...
            child: GeneralHeader(
              title: "Edit Account Email Address",
            ),
          ),
        ),
        body: Stack(
